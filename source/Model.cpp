...
SOLAR::Model::Model(std::string path, bool gammaCorrection) : gammaCorrection{ gammaCorrection }
{
	LoadModel(path);
}
...
void SOLAR::Model::Draw(Shader& shader)
{
...
void SOLAR::Model::LoadModel(std::string path)
{
	...
	{
		fmt::print(fmt::fg(fmt::color::crimson), "Assimp error: {}\n", importer.GetErrorString());
		return;
	}
...
void SOLAR::Model::ProcessNode(aiNode* node, const aiScene* scene)
{
...
SOLAR::Mesh SOLAR::Model::ProcessMesh(aiMesh* mesh, const aiScene* scene)
{
	// data to fill
...
unsigned int SOLAR::TextureFromFile(const char* path, const std::string& directory, bool gamma)
{
